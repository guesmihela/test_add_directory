...
class SPetRecoursencaissecadre(Document):
	pass

@frappe.whitelist()
def sinistre_cadre():

	sinistre_list = frappe.get_list("SP et Recours encaisse cadre",
	...
	for sinistre in sinistre_list:
		...
		frappe.db.set_value('SP et Recours encaisse cadre', sinistre.name, {'traiter': 1 })
