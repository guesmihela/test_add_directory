...
#####                    ----Section list ---------
                ...
                for sec in section_list :
                        ...
                        doc.base_engagement = sec.base_engagement
                        doc.base_cession = sec.base_cession
                        doc.taux_smp_min = sec.taux_smp_min
                        doc.choix_coassurance = sec.choix_coassurance
                        doc.limite_en_coassurance = sec.limite_en_coassurance
                        doc.cat_nat = sec.cat_nat
                        doc.limite_cat_nat_par_annee_assurance = sec.limite_cat_nat_par_annee_assurance
                        doc.limite_cat_nat_choix = sec.limite_cat_nat_choix
                        doc.limite_par_sinistre = sec.limite_par_sinistre
                        doc.limite_par_evenement = sec.limite_par_evenement
                        doc.r_politique = sec.r_politique
                        doc.limite_r_p_par_s = sec.limite_r_p_par_s
                        doc.limite_par_sinistre_r_p = sec.limite_par_sinistre_r_p
                        doc.limite_par_evenement_r_p = sec.limite_par_evenement_r_p
                        doc.limite_r_p_par_annee = sec.limite_r_p_par_annee
                        doc.choix = sec.choix
                        doc.limite_priorite = sec.limite_priorite
                        doc.taux_priorite = sec.taux_priorite
                        doc.choix_franchise_additionnelle = sec.choix_franchise_additionnelle
                        doc.franchise_annuelle = sec.franchise_annuelle
                        doc.choix_portee = sec.choix_portee
                        doc.limite_porte = sec.limite_portee
                        doc.taux_porte = sec.taux_portee
                        doc.limite_plafond = sec.limite_plafond
                        doc.taux_plafond = sec.taux_plafond
                        doc.plafond_annuel = sec.plafond_annuel
                        doc.clause_indexation = sec.clause_indexation
                        doc.date_deffet_indexation = sec.date_deffet_indexation
                        doc.taux_dindexation = sec.taux_dindexation
                        doc.cond_app_indexation = sec.cond_app_indexation
                        doc.taux_dinflation_clause_index = sec.taux_dinflation_clause_index
                        doc.clause_de_stabilisation = sec.clause_de_stabilisation
                        doc.annee_base = sec.annee_base
                        doc.indice_base = sec.indice_base
                        doc.date_deffet_app_clause_de_stabilisation = sec.date_deffet_app_clause_de_stabilisation
                        doc.valeur_lindice = sec.valeur_lindice
                        doc.condition_app_clause_stabilisation = sec.condition_app_clause_stabilisation
                        doc.taux_inflation_clause_sta = sec.taux_inflation_clause_sta
                        doc.insert()
